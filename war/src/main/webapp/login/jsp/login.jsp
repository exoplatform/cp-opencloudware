    ...
    <div class="uiLogin">
        ...
        <div class="centerLoginContent">
          <form name="loginForm" action="<%= contextPath + "/login"%>" method="post" style="margin: 0px;">
                ...
                <div class="spaceRole" style="display:none">
					<input type="checkbox" class="yesno" style="visibility: hidden;" id="rememberme" name="rememberme" value="false" data-yes="<%=res.getString("portal.login.Yes")%>" data-no="<%=res.getString("portal.login.No")%>"/>
