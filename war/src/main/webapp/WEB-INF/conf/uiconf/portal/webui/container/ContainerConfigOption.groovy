...
SelectItemCategory rounded = new SelectItemCategory("Rounded") ;
rounded.addSelectItemOption(new SelectItemOption("RoundedContainer",
		"<container template=\"system:/groovy/opencloudware/webui/container/UIRoundedContainer.gtmpl\"></container>",
		"OneRowContainerLayout"));

templates.add(rounded);
