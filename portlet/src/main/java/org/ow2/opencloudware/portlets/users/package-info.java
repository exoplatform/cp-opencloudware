...
@Assets(
		scripts = {
				...
				@Script(src = "js/users/users.js", depends = "jquery", location = AssetLocation.SERVER)

		},
		stylesheets = {

				@Stylesheet(id = "common", src = "skin/common/common.css", location = AssetLocation.SERVER),
				@Stylesheet(src = "skin/users/users.css", depends = "common", location = AssetLocation.SERVER)
