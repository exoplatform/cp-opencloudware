...
@Assets(
		scripts = {
				...
				@Script(src = "js/providerManagement/provider.js", depends = "jquery", location = AssetLocation.SERVER)

		},
		stylesheets = {

				@Stylesheet(id = "common", src = "skin/common/common.css", location = AssetLocation.SERVER),
				@Stylesheet(src = "skin/provider/provider.css", depends = "common", location = AssetLocation.SERVER)
