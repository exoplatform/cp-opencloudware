...
@Bindings(
		{
				...
				@Binding(value = org.exoplatform.services.organization.User.class),
				@Binding(value = org.exoplatform.services.mail.MailService.class)

		}
)

@Portlet
@Servlet("/myorganization/*")
...
@Assets(
		scripts = {
				...
				@Script(src = "js/myOrganization/myOrganization.js", depends = "jquery", location = AssetLocation.SERVER)

		},
		stylesheets = {

				@Stylesheet(id = "common", src = "skin/common/common.css", location = AssetLocation.SERVER),
				@Stylesheet(src = "skin/myOrganization/myOrganization.css", depends = "common", location = AssetLocation.SERVER)
