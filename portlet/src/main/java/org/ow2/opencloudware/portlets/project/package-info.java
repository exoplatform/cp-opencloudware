...
@Assets(
		scripts = {
				...
				@Script(src = "js/project/project.js", depends = "jquery", location = AssetLocation.SERVER)

		},
		stylesheets = {

				@Stylesheet(id = "common", src = "skin/common/common.css", location = AssetLocation.SERVER),
				@Stylesheet(src = "skin/project/project.css", depends = "common", location = AssetLocation.SERVER)
