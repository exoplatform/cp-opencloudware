...
@Assets(
		scripts = {
				...
				@Script(src = "js/organizationManagment/organization.js", depends = "jquery", location = AssetLocation.SERVER)

		},
		stylesheets = {
			@Stylesheet(id = "common", src = "skin/common/common.css", location = AssetLocation.SERVER),
			@Stylesheet(src = "skin/organizationManagment/organization.css", depends = "common", location = AssetLocation.SERVER)
		}
)
